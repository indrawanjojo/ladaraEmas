...
class Confirmations_model extends CI_Model
{
	...
	$this->db->or_like('sender_bank', $keyword);
	$this->db->or_like('bank_account_name', $keyword);
	$this->db->or_like('receiver_bank', $keyword);
	$this->db->or_like('amount', $keyword);
	$this->db->or_like('payment_date', $keyword);
...
/* End of file Confirmations_model.php */
